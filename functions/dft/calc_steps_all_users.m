function show_steps_all_users(datasets, num_users, dynamic_acts, labels, fs)
    ...
    acts_table = table(USER, WALK_MEAN, WALK_STD, WALK_UP_MEAN, WALK_UP_STD, WALK_DOWN_MEAN, WALK_DOWN_STD) 
end